    ...
    try {
      if (subcommand === 'enable') {
              ...
              actions: [
                {
                  ...
                  metadata: {
                    channel: interaction.channel,
                    durationSeconds: 10,
                    customMessage: 'Mensaje automáticamente borrado por menciones excesivas'
                  }
                }
              ]
            });
              ...
              actions: [
                {
                  ...
                  metadata: {
                    channel: interaction.channel,
                    durationSeconds: 10,
                    customMessage: 'Mensaje automáticamente borrado por contener palabras prohibidas'
                  }
                }
              ]
            });
                  ...
                  actions: [
                    {
                      ...
                      metadata: {
                        channel: interaction.channel,
                        durationSeconds: 10,
                        customMessage: 'Mensaje eliminado por contenido sexual inapropiado'
                      }
                    }
                  ]
                });
              ...
              actions: [
                {
                  ...
                  metadata: {
                    channel: interaction.channel,
                    durationSeconds: 10,
                    customMessage: 'Mensaje automáticamente borrado por contener una invitación'
                  }
                }
              ]
            });
        ...
        embed
          ...
          .setDescription(`La regla "${rule}" ha sido habilitada correctamente.`)
          .setColor('Green');
        ...
        const ruleToDelete = rules.find(r => {
          switch(rule) {
            case 'spam': return r.name === 'Prevenir Spam';
            case 'mentions': return r.name === 'Prevenir Menciones Masivas';
            case 'words': return r.name === 'Prevenir Palabras Prohibidas';
            case 'invites': return r.name === 'Prevenir Invitaciones';
          }
        });
        ...
        if (ruleToDelete) {
          ...
          embed
            ...
            .setDescription(`La regla "${rule}" ha sido deshabilitada correctamente.`)
            .setColor('Red');
        } else {
          embed
            .setTitle('Error')
            .setDescription(`No se encontró la regla "${rule}" para deshabilitar.`)
            .setColor('Red');
        }
      }
